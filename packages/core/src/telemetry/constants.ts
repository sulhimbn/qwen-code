...
export const SERVICE_NAME = 'qwen_code';
...
export const EVENT_API_CANCEL = 'qwen_code.api_cancel';
...
export const EVENT_SUBAGENT_EXECUTION = 'qwen_code.subagent_execution';
